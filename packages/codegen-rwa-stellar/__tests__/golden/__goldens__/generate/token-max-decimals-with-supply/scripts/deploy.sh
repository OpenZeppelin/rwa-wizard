...
echo ""
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo "${BOLD}${CYAN}  Deploying High Precision Token (HPT) — RWA Token System${RST}"
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo ""
...
echo "${BOLD}───────────────────────────────────────────────────────────────${RST}"
echo ""
echo "${BOLD}  Deploying HPT Token ...${RST}"
...
if [ $? -ne 0 ] || [ -z "$RWA_TOKEN_ADDRESS" ]; then
  echo "${RED}  ✗ Failed to deploy HPT Token (rwa-token)${RST}"
  exit 1
fi
echo "${GREEN}  ✓ HPT Token: ${RWA_TOKEN_ADDRESS}${RST}"
...
echo "  Requested: 1 base units (from config)"
...
echo "         --to <RECIPIENT> --amount 1  # base units"

echo ""
echo ""
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo "${BOLD}${CYAN}  Deployment Complete — High Precision Token (HPT)${RST}"
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo ""
echo "  Network:        Stellar Testnet"
echo "  Admin:          $ADMIN"
...
echo "  ${GREEN}HPT Token                     ${RST} ${RWA_TOKEN_ADDRESS}"
echo "${DIM}───────────────────────────────────────────────────────────────${RST}"
echo ""
