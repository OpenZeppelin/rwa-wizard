...
if [ -z "$SOURCE_ACCOUNT" ]; then
  ...
  echo "Example: export STELLAR_ACCOUNT=<identity-for-[preview] owner address>"
  exit 1
fi
...
echo ""
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo "${BOLD}${CYAN}  Deploying [preview] Token name ([preview]) — RWA Token System${RST}"
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo ""
...
echo "${BOLD}───────────────────────────────────────────────────────────────${RST}"
echo ""
echo "${BOLD}  Deploying [preview] Token ...${RST}"
...
if [ $? -ne 0 ] || [ -z "$RWA_TOKEN_ADDRESS" ]; then
  echo "${RED}  ✗ Failed to deploy [preview] Token (rwa-token)${RST}"
  exit 1
fi
echo "${GREEN}  ✓ [preview] Token: ${RWA_TOKEN_ADDRESS}${RST}"
...
echo ""
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo "${BOLD}${CYAN}  Deployment Complete — [preview] Token name ([preview])${RST}"
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo ""
echo "  Network:        Stellar Testnet"
echo "  Admin:          $ADMIN"
...
echo "  ${GREEN}[preview] Token               ${RST} ${RWA_TOKEN_ADDRESS}"
echo "${DIM}───────────────────────────────────────────────────────────────${RST}"
echo ""
