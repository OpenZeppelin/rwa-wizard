...
stellar contract invoke \
  ...
  -- \
  add_trusted_issuer \
  --trusted_issuer "$CLAIM_ISSUER_ADDRESS" --claim_topics '[1, 2, 7]' --operator "$MANAGER"
echo "${GREEN}  ✓ Registered demo issuer for claim topics [1, 2, 7]${RST}"
...
stellar contract invoke \
  ...
  -- \
  allow_key \
  --public_key 3b6a27bcceb6a42d62a3a8d02a6f0d73653215771de243a63ac048a18b59da29 --registry "$CTI_ADDRESS" --claim_topic 7
echo "${GREEN}  ✓ Allowed demo signing key for topic 7 (Accredited Investor)${RST}"
