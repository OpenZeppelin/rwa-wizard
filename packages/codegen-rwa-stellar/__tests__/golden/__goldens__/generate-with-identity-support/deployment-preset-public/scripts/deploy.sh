...
echo "${DIM}    Explorer: https://stellar.expert/explorer/public/contract/${CTI_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://stellar.expert/explorer/public/contract/${IRS_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://stellar.expert/explorer/public/contract/${IDENTITY_VERIFIER_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://stellar.expert/explorer/public/contract/${COMPLIANCE_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://stellar.expert/explorer/public/contract/${RWA_TOKEN_ADDRESS}${RST}"
...
echo "  This export includes example claim-issuer and identity crates (see README),"
echo "  but deploy.sh does not deploy or wire them automatically."
...
echo "${DIM}      https://stellar.expert/explorer/public/contract/${CTI_ADDRESS}${RST}"
echo "    Identity Registry Storage:"
echo "${DIM}      https://stellar.expert/explorer/public/contract/${IRS_ADDRESS}${RST}"
echo "    Identity Verifier:"
echo "${DIM}      https://stellar.expert/explorer/public/contract/${IDENTITY_VERIFIER_ADDRESS}${RST}"
echo "    Compliance:"
echo "${DIM}      https://stellar.expert/explorer/public/contract/${COMPLIANCE_ADDRESS}${RST}"
echo "    ACME Token:"
echo "${DIM}      https://stellar.expert/explorer/public/contract/${RWA_TOKEN_ADDRESS}${RST}"
