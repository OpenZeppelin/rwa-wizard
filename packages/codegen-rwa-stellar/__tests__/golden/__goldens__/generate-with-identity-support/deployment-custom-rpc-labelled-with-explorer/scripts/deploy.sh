...
CTI_ADDRESS=$(stellar contract deploy \
  ...
  --rpc-url 'https://rpc.example.test' \
  -- \
...
echo "${DIM}    Explorer: https://explorer.example.test/contract/${CTI_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://explorer.example.test/contract/${IRS_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://explorer.example.test/contract/${IDENTITY_VERIFIER_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://explorer.example.test/contract/${COMPLIANCE_ADDRESS}${RST}"
...
echo "${DIM}    Explorer: https://explorer.example.test/contract/${RWA_TOKEN_ADDRESS}${RST}"
...
echo "${DIM}      https://explorer.example.test/contract/${CTI_ADDRESS}${RST}"
echo "    Identity Registry Storage:"
echo "${DIM}      https://explorer.example.test/contract/${IRS_ADDRESS}${RST}"
echo "    Identity Verifier:"
echo "${DIM}      https://explorer.example.test/contract/${IDENTITY_VERIFIER_ADDRESS}${RST}"
echo "    Compliance:"
echo "${DIM}      https://explorer.example.test/contract/${COMPLIANCE_ADDRESS}${RST}"
echo "    ACME Token:"
echo "${DIM}      https://explorer.example.test/contract/${RWA_TOKEN_ADDRESS}${RST}"

write_deployment_manifest() {
  cat > deployment-manifest.json <<MANIFEST
{
  "network": "Example Devnet",
