...
echo ""
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo "${BOLD}${CYAN}  Deploying Minimal Features Token (MFT) — RWA Token System${RST}"
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo ""
...
echo "${BOLD}───────────────────────────────────────────────────────────────${RST}"
echo ""
echo "${BOLD}  Deploying MFT Token ...${RST}"
...
if [ $? -ne 0 ] || [ -z "$RWA_TOKEN_ADDRESS" ]; then
  echo "${RED}  ✗ Failed to deploy MFT Token (rwa-token)${RST}"
  exit 1
fi
echo "${GREEN}  ✓ MFT Token: ${RWA_TOKEN_ADDRESS}${RST}"
...
echo ""
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo "${BOLD}${CYAN}  Deployment Complete — Minimal Features Token (MFT)${RST}"
echo "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RST}"
echo ""
echo "  Network:        Stellar Testnet"
echo "  Admin:          $ADMIN"
...
echo "  ${GREEN}MFT Token                     ${RST} ${RWA_TOKEN_ADDRESS}"
echo "${DIM}───────────────────────────────────────────────────────────────${RST}"
echo ""
  ...
  cat > deployment-manifest.json <<MANIFEST
{
  ...
  "tokenName": "Minimal Features Token",
  "tokenSymbol": "MFT",
  "admin": "$ADMIN",
  "manager": "$MANAGER",
