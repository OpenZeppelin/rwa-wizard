...
- Code review enforces strict separation of concerns: rejection if UI contains chain-specific generation logic, template logic, or bypasses codegen package boundaries.
